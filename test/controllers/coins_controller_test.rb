...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { logo: @coin.logo, name: @coin.name, symbol: @coin.symbol } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { logo: @coin.logo, name: @coin.name, symbol: @coin.symbol } }
